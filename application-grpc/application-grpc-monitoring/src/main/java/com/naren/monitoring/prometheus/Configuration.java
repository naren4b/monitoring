...
/**
 * Holds information about which metrics should be kept track of during rpc
 * calls. Can be used to turn on more elaborate and expensive metrics, such as
 * latency histograms.
 */
public class Configuration {
	private static final double[] DEFAULTLATENCYBUCKETS = new double[] { .001, .005, .01, .05, 0.075, .1, .25, .5, 1, 2,
			5, 10 };
